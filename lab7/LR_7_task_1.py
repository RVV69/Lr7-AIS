...
# Set the number of logical cores manually
os.environ["LOKY_MAX_CPU_COUNT"] = "4"  # Replace 4 with the number of logical cores

# Suppress warnings from joblib.externals.loky.backend.context
